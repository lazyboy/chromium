...
var sendInt = null;
var keepSending = function() {
  sendInt = window.setInterval(send, 10);
};
var clearKeepSending = function() {
  if (sendInt != null) {
...
var init = function() {
  ...
  $('send').onclick = send;
  $('keepSending').onclick = keepSending;
  $('clearKeepSending').onclick = clearKeepSending;
